export enum HttpResponse {
  ...
  INVALID_USERNAME = "Username must contain only alphabets and a single space between words",
  INVALID_PASSWORD = "Password must be at least 8 characters long with uppercase, lowercase, number & special character",
